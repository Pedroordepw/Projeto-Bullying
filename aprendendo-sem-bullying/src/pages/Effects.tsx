      ...
      <div className='flex flex-row flex-wrap mb-8'>
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={efeito_1} alt='child with depression' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={efeito_2} alt='child with injuries' className='w-full md:w-96 max-w-1/2' />
          </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={efeito_3} alt='kid crying' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={efeito_4} alt='sad child with bad test result' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={efeito_5} alt='law book' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
