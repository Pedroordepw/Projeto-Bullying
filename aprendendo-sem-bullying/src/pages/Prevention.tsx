      ...
      <div className='flex flex-row flex-wrap mb-8'>
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={prevencao_1} alt='phrase: bullying is not a joke' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={prevencao_2} alt='boy following the rules' className='w-full md:w-96 max-w-1/2' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={prevencao_3} alt='happy kids at school' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={prevencao_4} alt='image: No-bullying' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={prevencao_5} alt='children holding a banner saying stop bullying' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
