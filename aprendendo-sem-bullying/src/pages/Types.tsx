      ...
      <div className='flex flex-row flex-wrap mb-8'>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={fisico} alt='kid bullying other kid' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={social} alt='kid bullying other kid' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={verbal} alt='kid bullying other kid' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2 mb-8 px-4'>
          ...
          <div className='flex items-center justify-center'>
            <img src={cibernetico} alt='kid bullying other kid' className='w-full md:w-96 max-w-full' />
          </div>
        </div>
      </div>
    </div>
